...
namespace ProjetAutoEcoleS4.Data
{
    internal class LeconDAO
    {
        ...
        public void AjouterLecon_DAO(Lecon c)
        {
            ...
            {
                cn.Open();
                string insertTable = "insert into Lecon(id_Lecon,date,eleve,moniteur,vehicule,montantFacture) Values (" + c.id_Lecon + "," + c.date_Lecon + "," + c.eleve.id_eleve + "," + c.moniteur + "," + c.vehicule + "," + c.montantFacture + ");";
